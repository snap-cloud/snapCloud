...
package.loaded.Identities = require("models.identities")
...
package.loaded.OAuthAuthorizationCodes = require("models.oauth_authorization_codes")
package.loaded.OAuthClients = require("models.oauth_clients")
package.loaded.OAuthRefreshTokens = require("models.oauth_refresh_tokens")
