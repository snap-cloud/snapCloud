...
app:match(api_route('collection_projects', '/users/:username/collections/:id/projects', CollectionController, { 'GET' }))
app:match(api_route('collection_project', '/users/:username/collections/:id/projects/:project_id', CollectionController, { 'GET', 'POST', 'DELETE' }))
