...
app:match(api_route('create_collection', '/users/:username/collections/', CollectionController, { 'POST' }))
app:match(api_route('collection_projects', '/users/:username/collections/:name/projects', CollectionController, { 'GET' }))
app:match(api_route('add_project', '/users/:username/collections/:name/projects', CollectionController, { 'POST' }))
app:match(api_route('collection_project', '/users/:username/collections/:name/projects/:project_id', CollectionController, { 'GET', 'DELETE' }))
